...
class ParticleSystem:
   ...
   def __init__(self, nparticles=10., mass=0.25, x_last=200., y_last=40., z_last=0., linear_spacing=True, g_acc=9.81, springc=9., dampc=15., framerate=60.):
        ...
        self.mass=mass
        self.t_radius=1.0
        self.linear_spacing=linear_spacing
   ...
   def updatePS(self):
        ...
        for i in range(1, final):
            ...
            self.get_forces(i)
            if i==self.nparticles-1:
                self.fmag[:, i]=-self.mass*self.g+self.Fsba+self.Fdba
            else:
...
# FIGURE OUT HOW TO GET THE VECTOR FORMAT FOR VISUALISATION
